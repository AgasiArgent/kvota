    ...
    const fetchOrganization = async () => {
      ...
      try {
        ...
        if (result.success && result.data && result.data.length > 0) {
          ...
          message.error('У вас нет доступа к организации. Создайте или присоединитесь к организации.')
        ...
        >
          <Row gutter={24}>
            ...
            <Col xs={24} lg={16}>
              ...
              <Card
                title="Реквизиты (ИНН, КПП, ОГРН)"
                style={{ marginTop: 24 }}
              >
                <Row gutter={16}>
                  <Col xs={24}>
                    <Text type="secondary">
                      {(companyType === 'ooo' || companyType === 'ao' || companyType === 'pao' || companyType === 'zao') && (
                        <>
                          <strong>ИНН организации:</strong> 10 цифр, <strong>КПП:</strong> 9 цифр, <strong>ОГРН:</strong> 13 цифр
                        </>
                      )}
                      {companyType === 'ip' && (
                        <>
                  ...
                  <Col xs={24} md={8}>
                    ...
                    >
                      <Input
                        size="large"
                        placeholder={(companyType === 'ooo' || companyType === 'ao' || companyType === 'pao' || companyType === 'zao') ? '7701234567' : '770123456789'}
                        maxLength={12}
                      />
                    </Form.Item>
                  </Col>
                  ...
                  {(companyType === 'ooo' || companyType === 'ao' || companyType === 'pao' || companyType === 'zao' || companyType === 'ip') && (
                    <Col xs={24} md={8}>
                      <Form.Item
                        name="ogrn"
                        label={(companyType === 'ooo' || companyType === 'ao' || companyType === 'pao' || companyType === 'zao') ? 'ОГРН' : 'ОГРНИП'}
                        rules={[
                          { validator: validateOGRNField },
                        ]}
                        tooltip={(companyType === 'ooo' || companyType === 'ao' || companyType === 'pao' || companyType === 'zao') ? 'ОГРН (13 цифр)' : 'ОГРНИП (15 цифр)'}
                      >
                        <Input
                          size="large"
                          placeholder={(companyType === 'ooo' || companyType === 'ao' || companyType === 'pao' || companyType === 'zao') ? '1234567890123' : '123456789012345'}
                          maxLength={15}
                        />
                      </Form.Item>
                    </Col>
