        ...
        <Col xs={24} sm={22} md={20} lg={16} xl={14}>
          ...
          >
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
                  ...
                  >
                    <Space>
                      ...
                      <div>
                        ...
                        <Text type="secondary">Начните с нуля и пригласите команду</Text>
                      </div>
                    </Space>
                  </div>
              ...
              <Card hoverable style={{ border: '1px solid #d9d9d9', opacity: 0.7 }}>
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    <Space>
                      ...
                      <div>
                        ...
                        <Text type="secondary">Получите приглашение от администратора</Text>
                      </div>
                    </Space>
                  </div>
                  ...
                  <Button size="large" icon={<TeamOutlined />} block disabled>
