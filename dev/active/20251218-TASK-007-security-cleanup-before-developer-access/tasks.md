...
### GitHub PAT
- [ ] CLAUDE.md - Replace `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` with `<YOUR_GITHUB_PAT>`
...
### Database Password
- [ ] .mcp.json - Replace `Y7pX9fL3QrD6zW` with `<DB_PASSWORD>`
...
### VPS Credentials
- [ ] .claude/SESSION_PROGRESS.md - Replace IP `217.26.25.207` with `<VPS_IP>`
