...
**Complete Mapping Table (Updated 2025-11-09):**
...
```python
INTERNAL_MARKUP_MAP = {
    ("Турция", "RU"): Decimal("0.02"),  # 2% (was 10%)
    ("Турция", "TR"): Decimal("0.00"),
    ("Турция (транзитная зона)", "RU"): Decimal("0.02"),  # 2% (was 10%)
    ("Турция (транзитная зона)", "TR"): Decimal("0.00"),
    ("Россия", "RU"): Decimal("0.00"),
    ("Россия", "TR"): Decimal("0.00"),
    ("Китай", "RU"): Decimal("0.02"),  # 2% (was 10%)
    ("Китай", "TR"): Decimal("0.00"),
    ("Литва", "RU"): Decimal("0.04"),  # 4% (was 13%)
    ("Литва", "TR"): Decimal("0.02"),  # 2% (was 3%)
    ("Латвия", "RU"): Decimal("0.04"),  # 4% (was 13%)
    ("Латвия", "TR"): Decimal("0.02"),  # 2% (was 3%)
    ("Болгария", "RU"): Decimal("0.04"),  # 4% (was 13%)
    ("Болгария", "TR"): Decimal("0.02"),  # 2% (was 3%)
    ("Польша", "RU"): Decimal("0.04"),  # 4% (was 13%)
    ("Польша", "TR"): Decimal("0.02"),  # 2% (was 3%)
    ("ЕС (между странами ЕС)", "RU"): Decimal("0.04"),  # 4% (was 13%)
    ("ЕС (между странами ЕС)", "TR"): Decimal("0.02"),  # 2% (was 3%)
    ("ОАЭ", "RU"): Decimal("0.03"),  # 3% (was 11%)
    ("ОАЭ", "TR"): Decimal("0.01"),
    ("Прочие", "RU"): Decimal("0.02"),  # 2% (was 10%)
